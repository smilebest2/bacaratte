...

{
	...
	define("MYSQL_DB_NAME", 'smilebest_baccarat');
...
$sql ="SELECT RACE_DATA1.NO,RACE_DATA1.sejyutu_month,SEJYUTUSYA.nick_name,RIYOUSHA.kanjyamei,RIYOUSHA.hokensyubetu,RIYOUSHA.kouhiumu FROM RACE_DATA1 ";
