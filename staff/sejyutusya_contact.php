...
require_once 'sejyutusya_contact_model.php';
...
$(document).ready(function() {
	...
	$('#delete').click(function(){
	    ...
	    var id = <?php echo json_encode($_GET["no"], JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT); ?>;
	    	$.ajax({
	            type: "POST",
	            url: '<?php echo url_sejyutusya_del; ?>',
	            data: {"delete_ck": true,"id":id},
	            success:function(j_data){
	            	if(j_data="OK"){
		            alert("削除しました。");
		        	location.replace( '<?php echo url_sejyutusya; ?>' );
		        	}else{
...
require_once 'sejyutusya_contact_data.php';
...
<br />
  ...
  <TBODY>
    <TR>
      ...
      <INPUT type="submit" value=" 戻る " name="cancel" style="position: relative; left: 420px; top: 0px;"></TD>
      <br />
    </TR>
  </TBODY>
