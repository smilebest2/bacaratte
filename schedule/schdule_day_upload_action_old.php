...
echo "::target_no:".$from["kanjya_no"][$target_no];
...
echo ":from_riyosya".$from_riyosya;
echo ":kyori".$kyori;
echo ":new_start_race".$new_start_race;
echo ":from_riyosya_add".$from_riyosya_add;
echo ":new_from_chiryoin".$new_from_chiryoin;
echo ":new_sejyutusya_add".$new_sejyutusya_add;
	...
	$sql .= "RIYOUSHA.kanjya_ido, ";
	$sql .= "RIYOUSHA.kanjya_keido, ";
	$sql .= "RIYOUSHA.hokensyubetu, ";
	$sql .= "RIYOUSHA.kouhiumu, ";
	...
	$mysql->actQuery($sql);
	$k_data = $mysql->getResult();
	$k_data_hokensyubetu =$k_data["hokensyubetu"];
	$k_data_kouhiumu =$k_data["kouhiumu"];
	$k_data_ouryouryo_ck =$k_data["ouryouryo_ck"];
