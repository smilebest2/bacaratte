...
header("Location: http://smilebes.info/index.html");
exit;
}
...
var id=<?php echo $sId ?>;
	...
	$('#calendar').fullCalendar({
		editable: true,
		events: "https://smilebest.info/schedule/events.php?no=" + id,
		...
		maxTime:'24:00:00',
			...
			eventClick: function(calEvent, jsEvent, view) {
				...
				location.href = "https://smilebest.info/schedule/calendar_edit.php?no=" + id + "&start=" + escape(calEvent.start.format('YYYY-MM-DD HH:mm:ss')) + "&end=" + escape(calEvent.end.format('YYYY-MM-DD HH:mm:ss'));
		...
		riyo = $('[name=required_riyousya]').val();
			...
			if (riyo) {
				...
				location.href="https://smilebest.info/schedule/calendar_edit_new.php?" + data;
