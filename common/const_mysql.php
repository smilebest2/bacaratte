...

{
	...
	define("MYSQL_DB_NAME", 'smilebest_3900');
...
define("SELECT015", "SELECT RIYOUSHA.NO,
		RIYOUSHA.ID,
		RIYOUSHA.kanjyamei,
		RIYOUSHA.nick_name,
		SEJYUTUSYA.name,
		...
		RIYOUSHA.douinengappi
		 FROM RIYOUSHA
		LEFT JOIN SEJYUTUSYA ON
		RIYOUSHA.syutanto = SEJYUTUSYA.NO ");
define("SELECT016", "SELECT RIYOUSHA.NO,
		RIYOUSHA.ID,
		RIYOUSHA.kanjyamei,
		RIYOUSHA.nick_name,
		SEJYUTUSYA.name,
		...
		RIYOUSHA.douinengappi
		 ...
		 LEFT JOIN SEJYUTUSYA ON
		 RIYOUSHA.syutanto = SEJYUTUSYA.NO ");
define("SELECT017","SELECT RIYOUSHA.NO,
		RIYOUSHA.ID,
		RIYOUSHA.kanjyamei,
		RIYOUSHA.nick_name,
		SEJYUTUSYA.name,
		RIYOUSHA. hokenjya_mei,
		RIYOUSHA.douinengappi
		FROM RIYOUSHA LEFT JOIN SEJYUTUSYA ON
		RIYOUSHA.syutanto = SEJYUTUSYA.NO ");
define("SELECT018","SELECT RIYOUSHA.NO,
		RIYOUSHA.ID,
		RIYOUSHA.kanjyamei,
		RIYOUSHA.nick_name,
		SEJYUTUSYA.name,
