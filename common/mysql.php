...
class MySQL_cls
{
	...
	{
		//MySQLへ接続
		$this->m_con = mysqli_connect('mysql1308.xserver.jp', 'smilebest_user1', 'Windows1', 'smilebest_3900');
		$sql_1 = "SELECT now();";
	...
	{
		//MySQLへ接続
		$Connect = mysqli_connect('mysql1308.xserver.jp', 'smilebest_user1', 'Windows1', 'smilebest_3900');
		if( !$Connect ){
	        print "接続できませんでした";
        	exit();
		}
