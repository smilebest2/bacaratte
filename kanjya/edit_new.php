...
if (isset($_SESSION["lat"])){
	...
	if (isset($_SESSION["required_kanjya_jyusyo"])) {
...
<form name="edit" action="appli_upload_action.php" method="post" enctype="multipart/form-data" >
...
<td>
<input type="text" name="required_from_chiryoin_kyori" style="ime-mode: active" maxlength="10" size="10" value="<?=$from_chiryoin_kyori?>"/>
&nbspkm
</td>
</tr>
<tr>
...
<th><?=$OURYOURYO_CK?></td>
<td>往療料
<input type="radio" name="required_ouryouryo_ck" value="あり"<?php if ($ouryouryo_ck == 'あり'){echo 'checked';}?>>あり
<input type="radio" name="required_ouryouryo_ck" value="なし"<?php if ($ouryouryo_ck == 'なし'){echo 'checked';}?>>なし
</td>
</tr>
<tr>
<th><?=$KOTEI_CK?></td>
...
<td>
<input type="checkbox" name="required_hari_ck" value="a"<?php if ($kotei_ck == "a"){echo 'checked';}?>>神経痛
<input type="checkbox" name="required_hari_ck" value="b"<?php if ($kotei_ck == "b"){echo 'checked';}?>>リウマチ
<input type="checkbox" name="required_hari_ck" value="c"<?php if ($kotei_ck == "c"){echo 'checked';}?>>頸腕症候群<br>
<input type="checkbox" name="required_hari_ck" value="d"<?php if ($kotei_ck == "d"){echo 'checked';}?>>五十肩
<input type="checkbox" name="required_hari_ck" value="e"<?php if ($kotei_ck == "e"){echo 'checked';}?>>腰痛症
<input type="checkbox" name="required_hari_ck" value="f"<?php if ($kotei_ck == "f"){echo 'checked';}?>>頚椎捻挫症後遺症<br>
<input type="checkbox" name="required_hari_ck" value="g"<?php if ($kotei_ck == "g"){echo 'checked';}?>>その他
...
<th><?=$HENKEITOSYU?></td>
<td>
<input type="checkbox" name="required_henkei_ck1" value="a"<?php if ($henkei_ck1 == "a"){echo 'checked';}?>>左上肢
<input type="checkbox" name="required_henkei_ck2" value="b"<?php if ($henkei_ck2 == "b"){echo 'checked';}?>>右上肢
<input type="checkbox" name="required_henkei_ck3" value="c"<?php if ($henkei_ck3 == "c"){echo 'checked';}?>>左下肢
<input type="checkbox" name="required_henkei_ck4" value="d"<?php if ($henkei_ck4 == "d"){echo 'checked';}?>>右下肢
</td>
</tr>
