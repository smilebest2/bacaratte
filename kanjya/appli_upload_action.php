 ...
 */
	...
	if (isset($_POST['cancel'])) {
		...
		$_SESSION["user_id"]=$_SESSION["knid"];
		$_SESSION["knid"]="";
...
//		}else{
		...
		if (isset($latlng['lng'])){
			$ng_flg="";
//			if(isset($_POST["required_syutanto"]) && isset($_POST["required_kanjya_ido"]) && isset($_POST["required_kanjya_keido"])){
				$seNO=htmlspecialchars($_POST["required_syutanto"], ENT_QUOTES);
				$mysql = new MySQL_cls();
				$mysql->MySQL();
				$sql = $sql = "select ido,keido from SEJYUTUSYA where NO = '$seNO'";
				$mysql->actQuery($sql);
...
$new_member_id= htmlspecialchars($_SESSION["mid"], ENT_QUOTES);
	...
	$mysql->MySQL();
	$mysql->TrsBegin();
	$sql = "INSERT INTO  RIYOUSHA (member_id,ID,kanjyamei,kanjyamei_kana,kanjya_seibetu,kanjya_yubin,kanjya_jyusyo,nick_name,kanjya_ido,kanjya_keido,kanjya_tel,kanjya_birth,hihokensya_simei,hihokensy_kana,hihokensya_seibetu,hihokensya_yubin,hihokensya_jyusyo,hihokensya_jyusyo_kana,hihokensya_birth,ouryouryo_ck,zokugara,hokensyubetu,hokenjya_bango,hokenjya_mei,hihokenjya_kigou,hihokenjya_bango,kouhiumu,sityosonbango,jyukyusyabango,syuhoken_wariai,kouhihoken_wariai,sejyutu,sejyutunaiyo,hatubyomataha,hatubyonengappi,tiryo_syobyomei,gyoumujyou,seikyukubun,tenki,syoryonengappi,sinsei_aten,sinsei_aten2,douiisi,douiisibyoin,isi_yubin,isijyusyo,isinosyobyomei,douinengappi,douikikan_ji,doukikan_itaru,tekiyo,from_chiryoin_kyori,sinseikaisu,syoubyou_sonota,other_ck,syutanto,hukutanto,ma_syobyomei,hidari_jyosi,migi_jyosi,hidari_kasi,migi_kasi,kukan,onanpo,denkikosen,henkeitosyu,ma_bt,hari_bt,kotei_ck,kotei_kyori)
            values ('$new_member_id','$new_id','$new_kanjyamei','$new_kanjyamei_kana','$new_kanjya_seibetu','$new_kanjya_yubin','$new_kanjya_jyusyo','$new_nick_name','$new_kanjya_ido','$new_kanjya_keido','$new_kanjya_tel','$new_kanjya_birth','$new_hihokensya_simei','$new_hihokensy_kana','$new_hihokensya_seibetu','$new_hihokensya_yubin','$new_hihokensya_jyusyo','$new_hihokensya_jyusyo_kana','$new_hihokensya_birth','$new_ouryouryo_ck','$new_zokugara','$new_hokensyubetu','$new_hokenjya_bango','$new_hokenjya_mei','$new_hihokenjya_kigou','$new_hihokenjya_bango','$new_kouhiumu','$new_sityosonbango','$new_jyukyusyabango','$new_syuhoken_wariai','$new_kouhihoken_wariai','$new_sejyutu','$new_sejyutunaiyo','$new_hatubyomataha','$new_hatubyonengappi','$new_tiryo_syobyomei','$new_gyoumujyou','$new_seikyukubun','$new_tenki','$new_syoryonengappi','$new_sinsei_aten','$new_sinsei_aten2','$new_douiisi','$new_douiisibyoin','$new_isi_yubin','$new_isijyusyo','$new_isinosyobyomei','$new_douinengappi','$new_douikikan_ji','$new_doukikan_itaru','$new_tekiyo','$new_from_chiryoin_kyori','$new_sinseikaisu','$new_syoubyou_sonota','$new_other_ck','$new_syutanto','$new_hukutanto','$new_ma_syobyomei','$new_hidari_jyosi','$new_migi_jyosi','$new_hidari_kasi','$new_migi_kasi','$new_kukan','$new_onanpo','$new_denkikosen','$new_henkeitosyu','$new_ma_bt','$new_hari_bt','$new_kotei_ck','$new_kotei_kyori')";
